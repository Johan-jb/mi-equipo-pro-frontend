...
function ModalAgregarJugador({ onClose, onJugadorCreado }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      onJugadorCreado(response.data.jugador);
      onClose();
    } catch (err) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
        <div className="p-6">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Agregar Nuevo Jugador</h2>
